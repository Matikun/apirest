...
<legend>Envianos tus comentarios</legend>
    <input type="text" name="name" placeholder="Escribe tu nombre" title="Nombre solo acepta letras y espacios"
      pattern="^[A-Za-zÑñÁáÉéÍíÓóÚúÜü\\s]+$" required>
    <input type="email" name="email" placeholder="Email" title="no ingresaste un email valido"
...
`
    ...
    function validationForm() {
      ...
      d.addEventListener("submit", e => {
        ...
        fetch("https://formsubmit.co/ajax/rossetmatias@gmail.com", {
          method: "POST",
          ...
          .catch(err => {
            console.log(err)
            let message = err.satusText || "ocurrio un error al enviar"
